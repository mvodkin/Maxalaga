...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ship = function () {
	  ...
	  _createClass(Ship, [{
	    ...
	    key: "setDirection",
	    value: function setDirection(keyIdentifier, boolean) {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function addKeyListeners() {
	      ...
	      document.addEventListener("keydown", function (e) {
	        debugger;
	        e.preventDefault();
	        _this2.ship.setDirection(e.keyIdentifier, true);
	        if (e.keyIdentifier === "U+0020") {
	          _this2.ship.shoot();
	        }
	        if (e.keyIdentifier === "p") {
	          createjs.Ticker.paused = !createjs.Ticker.paused;
	        }
	      });
	
	      document.addEventListener("keyup", function (e) {
	        _this2.ship.setDirection(e.keyIdentifier, false);
	      });
	    }
	  }, {
	    key: "addEnemies",
